<?php
    ...
    if(($_POST["telD"]==0)OR empty($_POST["cantidadD"])OR empty($_POST["descripcionD"])){
        ...
        VALUES ($idAdmin, $deudor, $cantidad,'$descripcion', NOW() ,1)";
        if ($conn->query($insert)===true){
            echo "<h2>La deuda ha sido añadido exitosamente!</h2>";
            echo"<a href='Agregar.php'>Regresar a formulario</a>";
        }
        else{
            echo "<h2>Error!</h2>";
...
<head>
    ...
    <link rel="stylesheet" href="../css/deuda.css" type="text/css">
